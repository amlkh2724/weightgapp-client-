...
//         setIsUp(true);
//         setGainWeight(true);
//         // getWeeks.weeksHistory[getWeeks.weeksHistory.length - 1].upOrDown = "up";
...
//         );
//         setIsUp(false);
//         // getWeeks.weeksHistory[getWeeks.weeksHistory.length - 1].upOrDown =
//         //   "down";
//         setGainWeight(false);
...
//               {/* {firstWeek && checklossOrGain} */}

//               {/* {firstWeek &&
//                 checklossOrGain(
//                   <td>
//                     {` ${isUp ? "+" : ""} ${totalAverageOnWeekGainOrLoss} kg`}
//                   </td>
//                 )}
//               {firstWeek &&
//                 !checklossOrGain(
...
const TotalWeight = ({ weightRecords }) => {
  ...
  const [firstWeek, setFirstWeek] = useState(false);
  const [isUp, setIsUp] = useState(false);
  // const [genderGoalWeightLossGain, setGenderGoal] = useState("");
  const [checklossOrGain, setCheckLossOrGain] = useState(false);
